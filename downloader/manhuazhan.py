...
class ManhuazhanComic(ComicSource):
    ...
    def search(self, keyword):
        logger.info('网站开启了验证码验证，无法使用搜索功能，请手动输入漫画地址。例如：i https://www.manhuazhan.com/comic/255423')
        ...
        search_url = '%s/index.php/search?key=%s&verify=1&callback=jQuery112406074091281837971_1750596681221&pcode=anys&_=1750596681224' % (self.base_url, keyword)
        arr = []
        try:
    ...
    def info(self, url):
        ...
        meta_table = root.xpath(
            '//div[contains(@class,"d-vod-type")]/p')
